...
var TranslateSchema = new mongoose.Schema({
	...
	outResponse: {type: mongoose.Schema.Types.Mixed, default: null},
	//
...
/*
module.exports.update = function(criteria, doc, options){
	// http://mongoosejs.com/docs/api.html#model_Model.update
	return new Promise(function(resolve, reject){
		Translate(criteria, doc, options || null).update(function(error, raw){
